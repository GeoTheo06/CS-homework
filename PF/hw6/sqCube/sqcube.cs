// Dafny program sqcube.dfy compiled into C#
...
// Command-line arguments: run sqcube.dfy
// sqcube.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static void SquareCube(BigInteger n, out BigInteger sq, out BigInteger cb)
    {
      sq = BigInteger.Zero;
      cb = BigInteger.Zero;
      BigInteger _0_i;
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      _out0 = IO.__default.ReadNat();
      _0_n = _out0;
      BigInteger _1_square;
      BigInteger _2_cube;
      BigInteger _out1;
      BigInteger _out2;
      __default.SquareCube(_0_n, out _out1, out _out2);
      _1_square = _out1;
      _2_cube = _out2;
      Dafny.Helpers.Print((_0_n));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("*")).ToVerbatimString(false));
      Dafny.Helpers.Print((_0_n));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("=")).ToVerbatimString(false));
      Dafny.Helpers.Print((_1_square));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_0_n));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("*")).ToVerbatimString(false));
      Dafny.Helpers.Print((_0_n));
