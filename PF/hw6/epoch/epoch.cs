// Dafny program epoch.dfy compiled into C#
...
// Command-line arguments: run epoch.dfy
// epoch.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    {
      BigInteger _0_day = BigInteger.Zero;
      BigInteger _1_ep = BigInteger.Zero;
      BigInteger _out0;
      _out0 = IO.__default.ReadInt();
      _1_ep = _out0;
      _0_day = Dafny.Helpers.EuclideanModulus(Dafny.Helpers.EuclideanDivision(_1_ep, (new BigInteger(3600)) * (new BigInteger(24))), new BigInteger(7));
      if ((_0_day).Sign == 0) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Thursday\n")).ToVerbatimString(false));
      } else if ((_0_day) == (BigInteger.One)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Friday\n")).ToVerbatimString(false));
      } else if ((_0_day) == (new BigInteger(2))) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Saturday\n")).ToVerbatimString(false));
      } else if ((_0_day) == (new BigInteger(3))) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Sunday\n")).ToVerbatimString(false));
      } else if ((_0_day) == (new BigInteger(4))) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Monday\n")).ToVerbatimString(false));
      } else if ((_0_day) == (new BigInteger(5))) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Tuesday\n")).ToVerbatimString(false));
      } else if ((_0_day) == (new BigInteger(6))) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Wednesday\n")).ToVerbatimString(false));
      }
    }
  }
