// Dafny program primes.dfy compiled into C#
...
// Command-line arguments: run primes.dfy
// primes.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static bool checkPrime(BigInteger n)
    {
      ...
      BigInteger _0_divisor;
      _0_divisor = new BigInteger(2);
      while (((_0_divisor) * (_0_divisor)) <= (n)) {
        if ((Dafny.Helpers.EuclideanModulus(n, _0_divisor)).Sign == 0) {
          res = false;
          return res;
        }
        _0_divisor = (_0_divisor) + (BigInteger.One);
      }
      res = true;
      return res;
      return res;
    ...
    {
      BigInteger _0_inp = BigInteger.Zero;
      BigInteger _out0;
      _out0 = IO.__default.ReadInt();
      _0_inp = _out0;
      bool _1_isPrime = false;
      _1_isPrime = true;
      if ((_0_inp).Sign == 0) {
        ...
        while ((_0_inp).Sign == 1) {
          bool _out1;
          _out1 = __default.checkPrime(_0_inp);
          _1_isPrime = _out1;
          if (!(_1_isPrime)) {
            Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("NO\n")).ToVerbatimString(false));
            goto after_1_0;
          }
          _0_inp = Dafny.Helpers.EuclideanDivision(_0_inp, new BigInteger(10));
        continue_1_0: ;
        }
      after_1_0: ;
        if (_1_isPrime) {
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("YES\n")).ToVerbatimString(false));
        }
      }
    }
  }
