// Dafny program hoareTriple.dfy compiled into C#
...
// Command-line arguments: run hoareTriple.dfy
// hoareTriple.dfy

method GivenHoareTriple(X: int, Y: int)
    returns (x: int, y: int)
  ensures x == y * y + X && y == Y
  decreases X, Y
{
...
method ExerciseHoareTriple(X: int, Y: int)
    returns (x: int, y: int)
  ensures x == y * y + X && y == Y
  decreases X, Y
{
  ...
  x := y * y + X;
  assert x == y * y + X && y + 1 == Y;
  assert y == Y - 1 && x == y * y + X;
  assert y == Y - 1;
  y := y + 1;
  assert y == Y && x == (y - 1) * (y - 1) + X;
  x := y * y + X;
  assert x == y * y + X && y == Y;
}
...
module IO {
  ...
  method {:axiom} ReadReal() returns (r: real)
  {
    ...
    for i: int := 0 to 3 {
      rawBinary := rawBinary + bits[i] as bv32 as bv96 << (i * 32) as bv7;
    }
    var raw := rawBinary as int;
    var flags := bits[3] as bv32;
    var scale := ((flags >> 16 as bv6) & 127) as int;
    var exp := 1;
    for _v2: int := 0 to scale {
      exp := exp * 10;
    }
    var sign := flags & 2147483648 != 0;
    if sign {
      raw := raw * -1;
    }
  ...
  export
    provides ReadLine, ReadChar, ReadInt, ReadInts, ReadNat, ReadNats, ReadReal, ReadReals
...
namespace IO {
  ...
  public partial class __default {
    public static Dafny.ISequence<Dafny.Rune> ReadLine()
    {
      ...
      System.String _0_ns;
      _0_ns = Console.ReadLine();
      if (!((_0_ns) != (object) ((System.String)null))) {
        throw new Dafny.HaltException("io.dfy(123,8): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("ReadLine failed").ToVerbatimString(false));}
      s = Dafny.Sequence<Dafny.Rune>.UnicodeFromString(_0_ns);
      return s;
      return s;
    }
    public static Dafny.Rune ReadChar()
    {
      Dafny.Rune c = new Dafny.Rune('D');
      int _0_cint;
      _0_cint = Console.Read();
      if (!(((_0_cint) >= (0)) && ((_0_cint) < (256)))) {
        throw new Dafny.HaltException("io.dfy(130,8): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Read failed").ToVerbatimString(false));}
      c = new Dafny.Rune((int)(_0_cint));
      return c;
      return c;
    }
    public static System.Char ReadNativeChar()
    {
      System.Char nc = default(System.Char);
      int _0_ni;
      _0_ni = Console.Read();
      if (!((_0_ni) != (-1))) {
        throw new Dafny.HaltException("io.dfy(139,8): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Unexpected End-of-File!").ToVerbatimString(false));}
      nc = Convert.ToChar(_0_ni);
      return nc;
    }
    public static System.String ReadWord()
    {
      System.String ns = default(System.String);
      Dafny.ISequence<System.Char> _0_ncs;
      _0_ncs = Dafny.Sequence<System.Char>.FromElements();
      System.Char _1_nc;
      System.Char _out0;
      _out0 = IO.__default.ReadNativeChar();
      _1_nc = _out0;
      bool _2_isWhiteSpace;
      _2_isWhiteSpace = Char.IsWhiteSpace(_1_nc);
      while (_2_isWhiteSpace) {
        System.Char _out1;
        _out1 = IO.__default.ReadNativeChar();
        _1_nc = _out1;
        _2_isWhiteSpace = Char.IsWhiteSpace(_1_nc);
      }
      while (!(_2_isWhiteSpace)) {
        _0_ncs = Dafny.Sequence<System.Char>.Concat(_0_ncs, Dafny.Sequence<System.Char>.FromElements(_1_nc));
        System.Char _out2;
        _out2 = IO.__default.ReadNativeChar();
        _1_nc = _out2;
        _2_isWhiteSpace = Char.IsWhiteSpace(_1_nc);
      }
      ns = Dafny.Helpers.ToString(_0_ncs);
      return ns;
      return ns;
    }
    public static BigInteger ReadInt()
    {
      BigInteger i = BigInteger.Zero;
      System.String _0_ns;
      System.String _out0;
      _out0 = IO.__default.ReadWord();
      _0_ns = _out0;
      i = BigInteger.Parse(_0_ns);
      return i;
      return i;
    }
    public static Dafny.ISequence<BigInteger> ReadInts(BigInteger n)
    {
      Dafny.ISequence<BigInteger> ints = Dafny.Sequence<BigInteger>.Empty;
      ints = Dafny.Sequence<BigInteger>.FromElements();
      BigInteger _hi0 = n;
      for (BigInteger _0___v0 = BigInteger.Zero; _0___v0 < _hi0; _0___v0++) {
        BigInteger _1_i;
        BigInteger _out0;
        _out0 = IO.__default.ReadInt();
        _1_i = _out0;
        ints = Dafny.Sequence<BigInteger>.Concat(ints, Dafny.Sequence<BigInteger>.FromElements(_1_i));
      }
      if (!((new BigInteger((ints).Count)) == (n))) {
        throw new Dafny.HaltException("io.dfy(204,8): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Not enough integers").ToVerbatimString(false));}
      return ints;
    }
    public static BigInteger ReadNat()
    {
      ...
      _0_i = _out0;
      if (!((_0_i).Sign != -1)) {
        throw new Dafny.HaltException("io.dfy(212,8): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Input is not an integer").ToVerbatimString(false));}
      n = _0_i;
      return n;
      return n;
    }
    public static Dafny.ISequence<BigInteger> ReadNats(BigInteger n)
    {
      Dafny.ISequence<BigInteger> nats = Dafny.Sequence<BigInteger>.Empty;
      nats = Dafny.Sequence<BigInteger>.FromElements();
      BigInteger _hi0 = n;
      for (BigInteger _0___v1 = BigInteger.Zero; _0___v1 < _hi0; _0___v1++) {
        BigInteger _1_i;
        BigInteger _out0;
        _out0 = IO.__default.ReadNat();
        _1_i = _out0;
        nats = Dafny.Sequence<BigInteger>.Concat(nats, Dafny.Sequence<BigInteger>.FromElements(_1_i));
      }
      if (!((new BigInteger((nats).Count)) == (n))) {
        throw new Dafny.HaltException("io.dfy(227,8): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Not enough natural numbers").ToVerbatimString(false));}
      return nats;
    }
    public static Dafny.BigRational ReadReal()
    {
      Dafny.BigRational r = Dafny.BigRational.ZERO;
      System.String _0_word;
      System.String _out0;
      _out0 = IO.__default.ReadWord();
      _0_word = _out0;
      int[] _1_bits;
      _1_bits = Decimal.GetBits(Decimal.Parse(_0_word));
      BigInteger _2_rawBinary;
      _2_rawBinary = BigInteger.Zero;
      BigInteger _hi0 = new BigInteger(3);
      for (BigInteger _3_i = BigInteger.Zero; _3_i < _hi0; _3_i++) {
        _2_rawBinary = (((_2_rawBinary) + ((((new BigInteger((uint)((_1_bits)[(int)(_3_i)]))) << ((int)((byte)((_3_i) * (new BigInteger(32)))))) & ((new BigInteger(1) << 96) - 1)))) & ((new BigInteger(1) << 96) - 1));
      }
      BigInteger _4_raw;
      _4_raw = _2_rawBinary;
      uint _5_flags;
      _5_flags = (uint)((_1_bits)[(int)(new BigInteger(3))]);
      BigInteger _6_scale;
      _6_scale = new BigInteger((Dafny.Helpers.Bv32ShiftRight(_5_flags, (int)((byte)(16)))) & (127U));
      BigInteger _7_exp;
      _7_exp = BigInteger.One;
      BigInteger _hi1 = _6_scale;
      for (BigInteger _8___v2 = BigInteger.Zero; _8___v2 < _hi1; _8___v2++) {
        _7_exp = (_7_exp) * (new BigInteger(10));
      }
      bool _9_sign;
      _9_sign = ((_5_flags) & (2147483648U)) != (0U);
      if (_9_sign) {
        _4_raw = (_4_raw) * (new BigInteger(-1));
      }
      Dafny.BigRational _10_rational;
      Dafny.BigRational _nw0 = new Dafny.BigRational(_4_raw, _7_exp);
      _10_rational = _nw0;
      r = Dafny.Helpers.Id<Dafny.BigRational>(_10_rational);
      return r;
      return r;
    }
    public static Dafny.ISequence<Dafny.BigRational> ReadReals(BigInteger n)
    {
      ...
      BigInteger _hi0 = n;
      for (BigInteger _0___v3 = BigInteger.Zero; _0___v3 < _hi0; _0___v3++) {
        Dafny.BigRational _1_r;
        Dafny.BigRational _out0;
        _out0 = IO.__default.ReadReal();
        _1_r = _out0;
        reals = Dafny.Sequence<Dafny.BigRational>.Concat(reals, Dafny.Sequence<Dafny.BigRational>.FromElements(_1_r));
      }
      if (!((new BigInteger((reals).Count)) == (n))) {
        throw new Dafny.HaltException("io.dfy(299,8): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Not enough reals").ToVerbatimString(false));}
      return reals;
    }
  }
} // end of namespace IO
namespace _module {
  ...
  public partial class __default {
    public static void GivenHoareTriple(BigInteger X, BigInteger Y, out BigInteger x, out BigInteger y)
    {
      x = BigInteger.Zero;
      y = BigInteger.Zero;
      y = (Y) - (BigInteger.One);
      x = ((y) * (y)) + (X);
      x = ((x) + ((new BigInteger(2)) * (y))) + (BigInteger.One);
      y = (y) + (BigInteger.One);
    }
    public static void ExerciseHoareTriple(BigInteger X, BigInteger Y, out BigInteger x, out BigInteger y)
    {
      x = BigInteger.Zero;
      y = BigInteger.Zero;
      y = (Y) - (BigInteger.One);
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      BigInteger _1_Y;
      BigInteger _out1;
      _out1 = IO.__default.ReadInt();
      _1_Y = _out1;
      BigInteger _2_x = BigInteger.Zero;
      BigInteger _3_y = BigInteger.Zero;
      BigInteger _out2;
      BigInteger _out3;
      __default.GivenHoareTriple(_0_X, _1_Y, out _out2, out _out3);
      _2_x = _out2;
      _3_y = _out3;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("x=")).ToVerbatimString(false));
      Dafny.Helpers.Print((_2_x));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" y=")).ToVerbatimString(false));
      Dafny.Helpers.Print((_3_y));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      BigInteger _4_x_k = BigInteger.Zero;
      BigInteger _5_y_k = BigInteger.Zero;
      BigInteger _out4;
      BigInteger _out5;
      __default.ExerciseHoareTriple(_0_X, _1_Y, out _out4, out _out5);
      _4_x_k = _out4;
      _5_y_k = _out5;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("x'=")).ToVerbatimString(false));
      Dafny.Helpers.Print((_4_x_k));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" y'=")).ToVerbatimString(false));
      Dafny.Helpers.Print((_5_y_k));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      if (((_4_x_k) != (_2_x)) && ((_5_y_k) != (_3_y))) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Houston, we've got a problem\n")).ToVerbatimString(false));
      }
    }
  }
