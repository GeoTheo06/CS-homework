// Dafny program missingDigit.dfy compiled into C#
...
// Command-line arguments: run missingDigit.dfy
// missingDigit.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      BigInteger _2_j = BigInteger.Zero;
      BigInteger _3_found = BigInteger.Zero;
      BigInteger[] _4_arr;
      ...
      while ((_1_i) < (new BigInteger(9))) {
        BigInteger _out0;
        _out0 = IO.__default.ReadInt();
        (_4_arr)[(int)((_1_i))] = _out0;
        _1_i = (_1_i) + (BigInteger.One);
      }
      _1_i = BigInteger.Zero;
      while ((_1_i) <= (new BigInteger(9))) {
        _2_j = BigInteger.Zero;
        _3_found = BigInteger.Zero;
        while ((_2_j) < (new BigInteger(9))) {
          if (((_4_arr)[(int)(_2_j)]) == (_1_i)) {
            _3_found = BigInteger.One;
            goto after_1_0;
          }
